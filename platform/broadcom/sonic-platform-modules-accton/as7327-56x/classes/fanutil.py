...
# HISTORY:
#    mm/dd/yyyy (A.D.)
#    12/16/2025: Vincent Chiang modify for as7327_56x
# ------------------------------------------------------------------
# ------------------------------------------------------------------
...
class FanUtil(object):
    ...
    BASE_VAL_PATH = '/sys/bus/i2c/devices/157-0062/{0}'
    FAN_DUTY_PATH = '/sys/bus/i2c/devices/157-0062/fan_duty_cycle_percentage'
...
#fan1_present
 ...
 #(FAN_NUM_2_IDX, FAN_NODE_DUTY_IDX_OF_MAP): 'fan2_duty_cycle_percentage',
    _fan_to_device_node_mapping = {
           ...
           (FAN_NUM_1_IDX, FAN_NODE_FRONT_SPD_OF_MAP)  : 'fan_front_speed_rpm_1',
           (FAN_NUM_1_IDX, FAN_NODE_REAR_SPD_OF_MAP)   : 'fan_rear_speed_rpm_1',
           ...
           (FAN_NUM_2_IDX, FAN_NODE_FRONT_SPD_OF_MAP)  : 'fan_front_speed_rpm_2',
           (FAN_NUM_2_IDX, FAN_NODE_REAR_SPD_OF_MAP)   : 'fan_rear_speed_rpm_2',
           ...
           (FAN_NUM_3_IDX, FAN_NODE_FRONT_SPD_OF_MAP)  : 'fan_front_speed_rpm_3',
           (FAN_NUM_3_IDX, FAN_NODE_REAR_SPD_OF_MAP)   : 'fan_rear_speed_rpm_3',
           (FAN_NUM_3_IDX, FAN_NODE_PRESENT_IDX_OF_MAP): 'fan_present_3',

           (FAN_NUM_4_IDX, FAN_NODE_FAULT_IDX_OF_MAP)  : 'fan_fault_4',
           (FAN_NUM_4_IDX, FAN_NODE_DIR_IDX_OF_MAP)    : 'fan_direction_4',
           (FAN_NUM_4_IDX, FAN_NODE_FRONT_SPD_OF_MAP)  : 'fan_front_speed_rpm_4',
           (FAN_NUM_4_IDX, FAN_NODE_REAR_SPD_OF_MAP)   : 'fan_rear_speed_rpm_4',
           (FAN_NUM_4_IDX, FAN_NODE_PRESENT_IDX_OF_MAP): 'fan_present_4',
           }
