#!/usr/bin/env python3
#
# Copyright (C) 2025 Accton Networks, Inc.
#
...
'modprobe ym2651y'                  ,
'modprobe accton_as7327_56x_fan'     ,
'modprobe optoe'      ,
'modprobe accton_as7327_56x_leds'      ,
'modprobe accton_as7327_56x_psu' ]
...
'echo as7327_56x_fan 0x66 > /sys/bus/i2c/devices/i2c-11/new_device ',
...
'echo as7327_56x_psu1 0x51 > /sys/bus/i2c/devices/i2c-17/new_device',
'echo ym2651 0x59 > /sys/bus/i2c/devices/i2c-17/new_device',
'echo as7327_56x_psu2 0x53 > /sys/bus/i2c/devices/i2c-13/new_device',
'echo ym2651 0x5b > /sys/bus/i2c/devices/i2c-13/new_device',
'echo as7327_56x_cpld1 0x60 > /sys/bus/i2c/devices/i2c-18/new_device',
'echo as7327_56x_cpld2 0x62 > /sys/bus/i2c/devices/i2c-12/new_device',
'echo as7327_56x_cpld3 0x64 > /sys/bus/i2c/devices/i2c-19/new_device']
            ...
            while attempt < max_retries:
                try:
                    ...
                    if result is not None:
                        ...
                        print(f"func:{func.__name__} with args {args} and kwargs {kwargs} returned None.")
                except Exception as e:
                    print(f"[{func.__name__}] {e}")

                attempt += 1
                if attempt < max_retries:
                    print(f"[{func.__name__}] Retrying in {wait_time} seconds...")
                    time.sleep(wait_time)
                else:
                    print("[{func.__name__}] Max retries reached. Returning None.")
                    return None
        return wrapper
