...
# HISTORY:
#    mm/dd/yyyy (A.D.)
#    12/16/2025: Vincent Chiang create for as7327-56x
# ------------------------------------------------------------------
...
try:
    ...
    from as7327_56x.fanutil import FanUtil
    from as7327_56x.thermalutil import ThermalUtil
except ImportError as e:
    raise ImportError('%s - required module not found' % str(e))

# Deafults
VERSION = '1.0'
FUNCTION_NAME = '/usr/local/bin/accton_as7327_monitor'
...
#1.	(sensor_LM75_49 + Thermal sensor_LM75_CPU) /2 =< 41C   , Keep 50%(0x05) Fan speed
#2.	(sensor_LM75_49 + Thermal sensor_LM75_CPU) /2 > 41C   , Change Fan speed from 50%(0x05) to % 78.8%(0x09)
#3.	(sensor_LM75_49 + Thermal sensor_LM75_CPU) /2 > 46C   , Change Fan speed from 78.8%(0x09) to 100%(0x0e)
...
#fan-dev 0-11 speed 0x05     Setup fan speed 50%
#fan-dev 0-11 speed 0x09     Setup fan speed 78.8%
#fan-dev 0-11 speed 0xE      Setup fan speed 100.00%
...
class device_monitor(object):
    ...
    def manage_fans(self):
        ...
        LEVEL_FAN_DEF:          [50,  0x5],
        LEVEL_FAN_MID:          [79,  0x9],
        ...
        global alarm_state
        fan_policy ={
        0: [0,     41000,   LEVEL_FAN_DEF],  #F2B_policy, B2F_plicy, PWM, reg_val
        1: [41000, 46000,   LEVEL_FAN_MID],
        2: [46000, 61000,   LEVEL_FAN_MAX],
