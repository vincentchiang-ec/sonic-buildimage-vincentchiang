...
# coding=utf-8
#
# Name: ssd.py, version: 1.0
#
# Description: Module contains an implementation of SONiC Platform Base API 
# and provides the SSD' information which are available in the platform
#
...
#  - Virtium
#  - SiliconMotion
# Copyright Â© Huawei Technologies Co., Ltd. 2020-2021. All rights reserved.
...
class SsdUtil(SsdBase):
    ...
    def __init__(self, diskdev):
        self.vendor_ssd_utility = {
            ...
            "SM619GXC" : { "utility" : SMARTCTL, "parser" : self.parse_siliconmotion_info },
            "SM619GEC" : { "utility" : SMARTCTL, "parser" : self.parse_siliconmotion_info },
    ...
    def parse_siliconmotion_info(self):
        #169 Unknown_Attribute       0x0000   100   100   000    Old_age   Offline      -       100
        self.health = self._parse_re(r'169 Unknown_Attribute\s*(.+?)\n', self.vendor_ssd_info).split()[7]
        #194 Temperature_Celsius     0x0000   100   100   000    Old_age   Offline      -       36 (63 62 24 19 33)
        self.temperature = self._parse_re(r'194 Temperature_Celsius\s*(.+?)\n', self.vendor_ssd_info).split()[7]
